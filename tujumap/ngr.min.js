...
(function(d, g, h) {
    ...
    ngr.Map.include({
        _updatePathViewport: function() {
            var a = ngr.Path.CLIP_PADDING,
                c = this.getSize(),
                e = ngr.DomUtil.getPosition(this._mapPane).multiplyBy(-1)._subtract(c.multiplyBy(a)._round()),
                a = e.add(c.multiplyBy(1 + 2 * a)._round());
            this._pathViewport = new ngr.Bounds(e, a)
        }
    });
    ...
    ngr.Path = ngr.Path.SVG && !d.NGR_PREFER_CANVAS || !ngr.Browser.canvas ? ngr.Path : ngr.Path.extend({
        ...
        _drawPath: function() {
            var a, c, e, f, d, g, h = this.options.weight % 2 / 2;
            this._ctx.beginPath();
            a = 0;
            for (e = this._parts.length; a < e; a++) {
                c = 0;
                for (f = this._parts[a].length; c < f; c++) d = this._parts[a][c], g = (0 === c ? "move" : "line") + "To", this._ctx[g](d.x + h, d.y + h);
    ...
    ngr.Map.include(ngr.Path.SVG && !d.NGR_PREFER_CANVAS || !ngr.Browser.canvas ? {} : {
        ...
        _updateCanvasViewport: function() {
            if (!this._pathZooming) {
                ...
                e.width = a.x * f;
                e.height = a.y * f;
                1 != f && (e.style.width = a.x + "px", e.style.height = a.y + "px", e.getContext("2d").scale(f, f));
    ...
    ngr.Polyline = ngr.Path.extend({
        ...
        _convertLatLngs: function(a, c) {
            ...
            for (f = a.length; e < f; e++) {
                if (ngr.Util.isArray(a[e]) && "number" !== typeof a[e][0]) return;
                d[e] = ngr.latLng(a[e])
            }
            return d
        },
        ...
        _onMove: function(a) {
            if (a.touches && 1 < a.touches.length) this._moved = !0;
                ...
                var c = a.touches && 1 === a.touches.length ? a.touches[0] : a,
                    c = (new ngr.Point(c.clientX, c.clientY)).subtract(this._startPoint);
                !c.x && !c.y || ngr.Browser.touch && 3 > Math.abs(c.x) + Math.abs(c.y) || (ngr.DomEvent.preventDefault(a), this._moved || (this.fire("dragstart"), this._moved = !0, this._startPos = ngr.DomUtil.getPosition(this._element).subtract(c), ngr.DomUtil.addClass(g.body, "ngr-dragging"), this._lastTarget = a.target || a.srcElement, ngr.DomUtil.addClass(this._lastTarget, "ngr-drag-target")), this._newPos = this._startPos.add(c), this._moving = !0, ngr.Util.cancelAnimFrame(this._animRequest), this._animRequest = ngr.Util.requestAnimFrame(this._updatePosition, this, !0, this._dragStartTarget))
            }
        },
        _updatePosition: function() {
            this.fire("predrag");
